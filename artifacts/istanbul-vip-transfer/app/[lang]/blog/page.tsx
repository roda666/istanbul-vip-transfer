/**
 * Translated blog listing page: /en/blog, /de/blog, /ru/blog, /ar/blog, etc.
...
export default async function TranslatedBlogPage({ params }: Props) {
  ...
  const headings: Record<string, string> = {
    ...
    ru: 'Статьи и гиды', ar: 'مقالات وأدلة', es: 'Artículos y guías',
    fr: 'Articles et guides', it: 'Articoli e guide', nl: 'Artikelen & gidsen',
  };
  const emptyMsg: Record<string, string> = {
    tr: 'İçerikler yakında Türkçe eklenecektir.', en: 'Articles in English are coming soon.',
    de: 'Artikel auf Deutsch folgen in Kürze.', ru: 'Статьи на русском языке скоро появятся.',
    ar: 'المقالات باللغة العربية ستكون متاحة قريباً.', es: 'Los artículos en español estarán disponibles próximamente.',
  ...
  return (
    <>
      <section className="py-20 min-h-screen" style={{ background: '#F7F8FC' }} dir={isRtl ? 'rtl' : 'ltr'}>
        <div className="max-w-5xl mx-auto px-5 md:px-8">
          <div className="mb-14 text-center">
            <span className="text-xs tracking-[0.3em] uppercase mb-3 block" style={{ color: '#C79A35', fontFamily: 'Inter, sans-serif' }}>Blog</span>
                  ...
                  >
                    ...
                    {post.sourceHeroImage && (
                      <div className="aspect-video overflow-hidden flex-shrink-0">
                        ...
                        <img src={post.sourceHeroImage} alt={post.sourceHeroImageAlt ?? post.title ?? post.sourceSlug}
