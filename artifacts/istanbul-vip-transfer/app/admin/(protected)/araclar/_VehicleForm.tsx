    ...
    <div style={{ maxWidth: '800px' }}>
      ...
      <div style={{ marginBottom: '16px' }}>
        <ImageUploadField
          ...
          ai={{ target: 'VEHICLE', id: vehicle?.id, placement: 'hero', imageField: 'cover_image', promptHint: 'Araç kapak görselini açıklayın…' }}
        />
        ...
        >
          ...
          <div style={{ marginBottom: '8px' }}>
            <ImageUploadField
              ...
              altLabel="ALT Metni"
              ai={{ target: 'VEHICLE', id: vehicle?.id, placement: 'body', imageField: 'gallery', promptHint: 'Araç galeri görselini açıklayın…' }}
            />
          </div>
        </div>
      ))}
      ...
      <div style={{ marginBottom: '16px' }}>
        <ImageUploadField
          ...
          ai={{ target: 'VEHICLE', id: vehicle?.id, placement: 'og', imageField: 'og_image', promptHint: 'Araç sosyal paylaşım görselini açıklayın…' }}
        />
      </div>
