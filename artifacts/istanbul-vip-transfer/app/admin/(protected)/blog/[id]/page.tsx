...
export default async function EditBlogPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ padding: '28px 24px' }}>
      <Link href="/admin/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#666', fontSize: '13px', fontFamily: 'Inter, sans-serif', textDecoration: 'none', marginBottom: '16px' }}><ArrowLeft size={14} /> Blog&apos;a Dön</Link>
