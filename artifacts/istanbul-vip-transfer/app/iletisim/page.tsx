...
export const metadata: Metadata = {
  ...
  description:
    'VIP Transfer Istanbul iletişim. +90 505 587 70 06 numaralı hattımızı arayın veya WhatsApp üzerinden rezervasyon yapın. 7/24 hizmet.',
  alternates: { canonical: PAGE },
  openGraph: {
    title: 'İletişim | VIP Transfer Istanbul',
    description:
      '+90 505 587 70 06 — 7/24 ulaşın. WhatsApp ile hızlı rezervasyon ve destek.',
    url: PAGE,
