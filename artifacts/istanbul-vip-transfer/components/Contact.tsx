...
export default function Contact({ homepageMode = false }: { homepageMode?: boolean }) {
  const { dict } = useLang();
  const c = dict.contact;
  const cs = useSiteSettings();
  const cms = useHomepageCms();
  const section = homepageMode ? cms?.contactSection : null;
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8">
        ...
        >
          ...
          <p className="text-base max-w-lg mx-auto" style={{ color: '#50677A', fontFamily: 'Inter, sans-serif' }}>
            {section?.subheading ?? c.subheading}
          </p>
        </div>
        ...
        >
          ...
          <a
            ...
            style={{ background: '#0B7245', color: '#FFFFFF', fontFamily: 'Inter, sans-serif', letterSpacing: '0.04em' }}
          ...
          >
            ...
            {section?.whatsappCtaText ?? c.whatsappCta}
          </a>
        </div>
