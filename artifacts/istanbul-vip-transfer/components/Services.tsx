...
import { Plane, Hotel, Map, Briefcase, PartyPopper, Moon } from 'lucide-react';
...
const services = [
  ...
  {
    icon: Moon,
    title: 'VIP Gece Transferi',
    description: 'Gece kulüpleri, restoranlar ve özel mekanlar arası lüks, güvenli gece transferi.',
  },
];
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((service, i) => (
            <motion.div
              key={service.title}
              className="group relative p-8 rounded-xl overflow-hidden cursor-pointer transition-all duration-500"
              style={{
