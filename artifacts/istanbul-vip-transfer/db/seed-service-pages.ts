...
interface ServiceSeed {
  ...
  bodyOverride?: string;
  /** Optional: hero image path. Defaults to DEFAULT_OG_IMAGE. */
  heroImage?: string;
  /** Optional: category (airport|vip|intercity|tour|corporate|health|rental). */
  category?: string;
...
const SERVICES: ServiceSeed[] = [
  ...
  // ── New services added (v2 body with full rich content) ──────────────────
  {
    ...
    heroImage: '/hero-images/ankara-vip-transfer.jpg',
    category: 'airport',
    showOnHomepage: true,
  ...
  },
  {
    ...
    heroImage: '/hero-images/antalya-vip-transfer.jpg',
    category: 'airport',
    showOnHomepage: true,
  ...
  },
  {
    ...
    heroImage: '/hero-images/izmir-vip-transfer.jpg',
    category: 'airport',
    showOnHomepage: true,
  ...
  },
  {
    ...
    heroImage: '/hero-images/gelin-arabasi-kiralama.jpg',
    category: 'rental',
    showOnHomepage: true,
  ...
  },
  {
    ...
    heroImage: '/hero-images/vip-protokol-secim-araci.jpg',
    category: 'corporate',
    showOnHomepage: true,
  ...
  },
  {
    ...
    heroImage: '/hero-images/gunluk-villa-kiralama.jpg',
    category: 'rental',
    showOnHomepage: true,
...
async function seed() {
  ...
  for (const s of SERVICES) {
    ...
    const heroImg = s.heroImage ?? DEFAULT_OG_IMAGE;
