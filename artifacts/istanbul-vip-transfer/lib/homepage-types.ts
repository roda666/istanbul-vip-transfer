...
export const HOMEPAGE_FALLBACK: Record<string, HomepageSections> = {
  ...
  es: {
    ...
    vehiclesSection:    { heading: 'Nuestra flota Mercedes de lujo', description: 'Dos opciones de vehículos de alta gama para cada necesidad, totalmente equipadas para su comodidad.', ctaText: 'Reservar ahora', ctaRoute: '#rezervasyon', enabled: true },
  ...
  fr: {
    ...
    vehiclesSection:    { heading: 'Notre flotte de Mercedes de luxe', description: 'Deux véhicules haut de gamme pour chaque besoin — tous deux entièrement équipés pour votre confort.', ctaText: 'Réserver maintenant', ctaRoute: '#rezervasyon', enabled: true },
  ...
  it: {
    ...
    vehiclesSection:    { heading: 'La nostra flotta Mercedes di lusso', description: 'Due veicoli di categoria superiore per ogni esigenza, entrambi completamente equipaggiati per il tuo comfort.', ctaText: 'Prenota ora', ctaRoute: '#rezervasyon', enabled: true },
  ...
  nl: {
    ...
    vehiclesSection:    { heading: 'Ons luxe Mercedes-wagenpark', description: 'Twee topklasse voertuigopties voor elke behoefte — beide volledig uitgerust voor uw comfort.', ctaText: 'Nu boeken', ctaRoute: '#rezervasyon', enabled: true },
