...
export default function BookingForm() {
  ...
  return (
    <section id="rezervasyon" className="py-24 relative" style={{ background: 'linear-gradient(180deg, #0A0A0A 0%, #111111 50%, #0A0A0A 100%)' }} data-testid="booking-section">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div data-testid="field-nereye">
                ...
                <select
                  {...register('nereye')}
                  className="vip-input vip-select"
                  data-testid="input-nereye"
                >
                  <option value="">Varış noktası seçin</option>
                  {locations.filter(l => l !== neredenValue).map((loc) => (
                    <option key={loc} value={loc}>{loc}</option>
                  ))}
                </select>
              ...
              <div data-testid="field-yolcu">
                ...
                <select
                  {...register('yolcuSayisi')}
                  className="vip-input vip-select"
                  data-testid="input-yolcu"
                >
