...
import heroImage from '@assets/generated_images/istanbul-hero.jpg';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, rgba(10,10,10,0.65) 0%, rgba(10,10,10,0.45) 40%, rgba(10,10,10,0.75) 80%, rgba(10,10,10,1) 100%)' }} />
        ...
        >
          {[
            ...
            <div key={i} className="flex flex-col items-center" data-testid={`hero-trust-item-${i}`}>
              ...
              <span className="text-[11px] tracking-widest uppercase mt-1" style={{ color: '#666', fontFamily: 'Inter, sans-serif' }}>{item.label}</span>
            </div>
          ))}
        </motion.div>
      </div>
      ...
      >
        <span className="text-[10px] tracking-[0.3em] uppercase" style={{ color: '#666', fontFamily: 'Inter, sans-serif' }}>Aşağı Kaydır</span>
        <motion.div
          animate={{ y: [0, 6, 0] }}
